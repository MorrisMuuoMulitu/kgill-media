    ...
    >
      <div className={`flip-card-inner h-full transition-all duration-700 ${isFlipped ? 'rotate-y-180' : ''}`}>
        ...
        <div className={`flip-card-front bg-gradient-to-br ${gradient} p-6 sm:p-8 flex flex-col items-center justify-center text-center relative overflow-hidden rounded-2xl shadow-xl group-hover:shadow-2xl transition-all duration-300`}>
          ...
          <div className="absolute bottom-4 left-4 w-4 h-4 bg-charcoal/20 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }} aria-hidden="true"></div>
        </div>
        ...
        <div className="flip-card-back bg-slate-800 p-6 sm:p-8 flex flex-col justify-between border border-slate-700 relative overflow-hidden rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300">
          ...
          <div className="relative z-10">
            <h3 className="text-lg sm:text-xl font-bold font-montserrat text-white mb-4">{title}</h3>
          ...
          <div className="space-y-4 relative z-10">
            ...
            <button className="w-full flex items-center justify-center gap-2 text-marigold font-inter font-semibold hover:text-terracotta transition-colors group border border-marigold/30 rounded-lg py-3 hover:border-terracotta/30 focus:outline-none focus:ring-2 focus:ring-marigold/50 min-h-[44px]">
              View Portfolio 
